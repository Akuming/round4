...
<nav className="bg-white px-2 sm:px-4 py-2.5 dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-green-600 rounded-lg dark:border-gray-600">
  ...
  <div className="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
    <ul className="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-600">
      <li>
        <a href="#" className="block py-2 pr-4 pl-3 font-sans text-white text-lg bg-green-600 rounded md:bg-transparent md:text-green-600 md:p-0 dark:text-white" aria-current="page">Browse Riddles</a>
      </li>
      <li>
      ...
      <li>
        <a href="#" className="block py-2 pr-4 pl-3 font-sans text-gray-600 text-lg rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-green-600 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-600">Services</a>
      </li>
      <li>
        <a href="#" className="block py-2 pr-4 pl-3 font-sans text-gray-600 text-lg rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-green-600 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-600">Contact</a>
      </li>
    </ul>
  </div>
  </div>
